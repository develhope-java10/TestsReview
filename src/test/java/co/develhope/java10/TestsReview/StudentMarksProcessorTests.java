...
public class StudentMarksProcessorTests {
	...
	@Test
	void testWithEmptyClassroom() throws AverageMarksException {
		double average = marksProcessor.getClassroomMarks(new ArrayList<>());
		assertEquals(0.0, average, EQUAL_DELTA);
	}
	
	@Test
	void testWithHighAverage() throws AverageMarksException {
	...
	@Test
	void testWithOneStudent() throws AverageMarksException {
		List<Student> classroom = new ArrayList<>();
		classroom.add(new Student(1, "Mario Rossi", 9.0));
		double average = marksProcessor.getClassroomMarks(classroom);
	...
	@Test
	void oneStudentWithNullName() throws AverageMarksException {
		List<Student> classroom = new ArrayList<>();
	...
	@Test
	void testOneStudentWithNegativeAverage() {
		List<Student> classroom = new ArrayList<>();
		classroom.add(new Student(1, "Mario Rossi", 9.0));
		classroom.add(new Student(2, "Giorgio Bianchi", -8.0));
		classroom.add(new Student(3, "Giorgia Bianco", 8.0));
		
		assertThrows(AverageMarksException.class, () -> marksProcessor.getClassroomMarks(classroom));
	}
}
